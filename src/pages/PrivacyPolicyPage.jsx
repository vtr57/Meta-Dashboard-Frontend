  ...
  return (
    <main className="privacy-page">
      <article className="privacy-card">
        ...
        <p>
          Esta Politica de Privacidade explica como o Meta Local Dashboard 9 (&quot;App&quot;) coleta, usa, armazena e
          compartilha dados quando voce cria uma conta e utiliza as funcionalidades do nosso dashboard.
        </p>
        ...
        <p>
          <strong>Importante:</strong> nao vendemos seus dados, nem usamos tokens para finalidades fora do
        ...
        <ul>
          ...
          <li>Plataformas integradas, como a Meta, para executar requisicoes e exibir os dados no dashboard</li>
        ...
        <p>
          Quando voce conecta sua conta, o App pode acessar dados autorizados por voce dentro das permissoes
          concedidas na plataforma da Meta.
        </p>
        <ul>
        ...
        <p>
          <strong>Retencao:</strong> guardamos dados pelo tempo necessario para operar o servico, cumprir obrigacoes
          legais, resolver disputas e manter registros de seguranca e auditoria.
        </p>
        <p>
          Quando nao for mais necessario, os dados poderao ser excluidos ou anonimizados, salvo obrigacao legal de
          retencao.
        </p>

        <h2>8. Transferencia internacional de dados</h2>
        <p>
          Dependendo dos provedores e integracoes (por exemplo, servicos em nuvem e Meta), seus dados podem ser
          processados fora do Brasil. Nesses casos, buscamos garantir medidas adequadas de protecao e conformidade
          com a LGPD.
        </p>
        ...
        <p>
          Podemos enviar comunicacoes relacionadas ao funcionamento do App, como alertas de seguranca, avisos de
          manutencao e mensagens de suporte.
        </p>
        <p>
          Mensagens promocionais, quando existirem, serao enviadas apenas quando permitido, e voce podera optar por
          nao recebe-las.
        </p>

        <h2>11. Privacidade de menores</h2>
        <p>
          O App nao e direcionado a menores de 18 anos, salvo quando autorizado e supervisionado por responsavel legal,
          conforme aplicavel. Se voce acredita que dados de menor foram tratados indevidamente, contate-nos para
          avaliacao e providencias.
        </p>

        <h2>12. Alteracoes desta Politica</h2>
        <p>
          Podemos atualizar esta Politica para refletir melhorias no App ou exigencias legais. Quando houver mudancas
          relevantes, vamos informar no App ou por e-mail.
        </p>
